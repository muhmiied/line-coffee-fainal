...
- **MISSING (no DB):** order_item_components · raw-bean inventory · packaging · promo_codes · refunds/returns · reviews · contact_messages · analytics. FIFO lot **consumption**/COGS not built (lots are created but not drawn down — Phase 5). **Media Studio does not exist and is cancelled (Decision 1).**
