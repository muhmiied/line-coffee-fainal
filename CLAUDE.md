...
- **MOCK (UI only, resets on refresh):** Admin Inventory's coffee/bean/supplier views, broad Marketing admin, Espresso Manager, and Flavor Manager. The Admin Inventory **Packaging** tab is real as of Phase 19B; Dashboard, Accounting, and Analytics are also real in their documented phases.
