...
export type RelatedCategory = PublicCatalogCategory & { productCount: number };

export type CategoryPageClientProps = {
  category: PublicCatalogCategory;
  products: PublicCatalogProduct[];
  relatedCategories: RelatedCategory[];
};

export default function CategoryPageClient({ category, products, relatedCategories }: CategoryPageClientProps) {
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4">
          ...
          <div className="mt-8 max-w-3xl">
            ...
            <div className="mt-6 inline-flex rounded-full border border-[#D6A373]/22 bg-[#120D09]/62 px-4 py-2 text-xs font-semibold text-[#D6A373] backdrop-blur-md">
              <span className="arabic-number">{products.length}</span>
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-4">
                  ...
                  <p className="mt-1 text-xs font-semibold text-[#D6A373]">
                    {item.productCount} {t({ en: "products", ar: "منتج" })}
                  </p>
                </div>
              </Link>
            ))}
