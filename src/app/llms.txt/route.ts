...
export function GET(): Response {
  ...
  const lines: string[] = [
    ...
    `- Make Your Espresso — build a custom espresso blend by bean ratio: ${SITE_URL}/make-your-espresso`,
    `- Make Your Flavor — build a custom flavored coffee: ${SITE_URL}/make-your-flavor`,
    "",
    "## Key pages",
    `- Home: ${SITE_URL}/`,
